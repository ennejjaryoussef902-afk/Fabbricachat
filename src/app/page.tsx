	...
	return (
		<main
			...
			<div
				...
				<p style={{ color: "#667781", fontSize: "15px", marginBottom: "30px" }}>La tua officina dei messaggi</p>
				...
				<div
					...
					<a href="/privacy" style={{ color: "#00a5e4", textDecoration: "none" }}>
						Privacy Policy
					</a>
					<a href="/terms" style={{ color: "#00a5e4", textDecoration: "none" }}>
						Terms
					</a>
				</div>
			</div>
